 ...
 */
public class just_rs_oldlim implements Runnable {
    private final String problemID = getClass().getName().split("_")[0].toLowerCase();
    private BufferedReader in;
    private PrintWriter out;
    
    private static final int MAX_DIGITS_SUM = 90;
    ...
    private void solve() throws IOException {
        ...
        check((1 <= n) && (n <= 10000000000L), "n is not in [1..10^10]");
    ...
    public static void main(String[] args) {
        new Thread(new just_rs_oldlim()).start();
    }
